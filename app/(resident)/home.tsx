...
import SosBroadcastOverlay from "@/components/sos/SosBroadcastOverlay";
...
const Home = () => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      {/* SOS COUNTDOWN + BROADCASTING OVERLAYS */}
      <SosBroadcastOverlay
        isCountingDown={isCountingDown}
        countdown={countdown}
        countdownScaleAnim={scaleAnim}
        alertActive={alertActive}
        userProfile={userProfile}
        sosBroadcastState={sosBroadcastState}
        sosBroadcastError={sosBroadcastError}
